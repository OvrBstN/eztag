 ...
 * ```
 */
export declare const Auth: <UserInput extends BaseUserInput>(fastify: FastifyInstance, options: GadgetAuthOptions<UserInput>, done: HookHandlerDoneFunction) => void;
export {};
