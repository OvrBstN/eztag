...
const googleResultToUser = (result) => ({
    ...
    googleProfileId: String(result.sub),
});
...
const userNeedsUpdate = (userRecord, googleUser) => {
    return ((userRecord.firstName !== undefined && userRecord.firstName !== googleUser.given_name) ||
        (userRecord.lastName !== undefined && userRecord.lastName !== googleUser.family_name) ||
        (userRecord.googleImageUrl !== undefined && userRecord.googleImageUrl !== googleUser.picture) ||
        (userRecord.emailVerified !== undefined && userRecord.emailVerified !== googleUser.email_verified) ||
        (userRecord.googleProfileId !== undefined && userRecord.googleProfileId !== googleUser.sub));
};
