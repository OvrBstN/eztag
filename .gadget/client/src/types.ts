...
export type CreateAllowedTagInput = {
...
export type BulkCreateAllowedTagsInput = {

  allowedTag?: CreateAllowedTagInput | null;
};



export type UpdateAllowedTagInput = {
...
export type BulkUpdateAllowedTagsInput = {

  allowedTag?: UpdateAllowedTagInput | null;
...
export type InternalAllowedTagInput = {
...
export type AllowedTagConnection = {
...
export type InternalAllowedTagRecordConnection = {
...
export type InternalAllowedTagRecordEdge = {
...
export type Mutation = {
  ...
  bulkCreateAllowedTags: (BulkCreateAllowedTagsResult | null);

  updateAllowedTag: (UpdateAllowedTagResult | null);

  bulkUpdateAllowedTags: (BulkUpdateAllowedTagsResult | null);
...
export type AvailableMutationSelection = {
  ...
  bulkCreateAllowedTags?: AvailableBulkCreateAllowedTagsResultSelection;

  updateAllowedTag?: AvailableUpdateAllowedTagResultSelection;

  bulkUpdateAllowedTags?: AvailableBulkUpdateAllowedTagsResultSelection;
...
export type CreateAllowedTagResult = {
...
/** The output when running the create on the allowedTag model in bulk. */
export type BulkCreateAllowedTagsResult = {

  __typename: 'BulkCreateAllowedTagsResult';
  ...
  /** The list of all changed allowedTag records by each sent bulk action. Returned in the same order as the input bulk action params. */
  allowedTags: (AllowedTag | null)[];
};



export type AvailableBulkCreateAllowedTagsResultSelection = {
  ...
  /** The list of all changed allowedTag records by each sent bulk action. Returned in the same order as the input bulk action params. */
  allowedTags?: AvailableAllowedTagSelection;
};



export type UpdateAllowedTagResult = {
...
/** The output when running the update on the allowedTag model in bulk. */
export type BulkUpdateAllowedTagsResult = {

  __typename: 'BulkUpdateAllowedTagsResult';
...
export type AvailableBulkUpdateAllowedTagsResultSelection = {
...
export type DeleteAllowedTagResult = {
...
/** The output when running the delete on the allowedTag model in bulk. */
export type BulkDeleteAllowedTagsResult = {
...
export type InternalMutations = {
  ...
  triggerCreateAllowedTag: (CreateAllowedTagResult | null);

  triggerUpdateAllowedTag: (UpdateAllowedTagResult | null);

  triggerDeleteAllowedTag: (DeleteAllowedTagResult | null);
...
export type AvailableInternalMutationsSelection = {
  ...
  triggerCreateAllowedTag?: AvailableCreateAllowedTagResultSelection;

  triggerUpdateAllowedTag?: AvailableUpdateAllowedTagResultSelection;

  triggerDeleteAllowedTag?: AvailableDeleteAllowedTagResultSelection;
...
export type InternalCreateAllowedTagResult = {
...
export type InternalUpdateAllowedTagResult = {
...
export type InternalDeleteAllowedTagResult = {
...
export type InternalDeleteManyAllowedTagResult = {
...
export type InternalBulkCreateAllowedTagsResult = {
